...
// IntervieweeApplicationpage 컴포넌트 정의
    ...
    <div className={styles.RootContainer}>
      ...
      <div className={styles.Column}>
        <div className={styles.FormContainer}>
          <span className={styles.FormContainerTitle}>원하는 인터뷰 방법</span>
          <div className={styles.CheckboxContainer}>
            <input type='checkbox' id='face' name='face' />
            <label htmlFor='face' className={styles.Checkbox}>
              대면
            </label>
            <input type='checkbox' id='onlinemeet' name='onlinemeet' />
            <label htmlFor='onlinemeet' className={styles.Checkbox}>
              화상채팅
            </label>
            <input type='checkbox' id='call' name='call' />
            <label htmlFor='call' className={styles.Checkbox}>
              전화
            </label>
          </div>
        </div>
        ...
        <div className={styles.FormContainer2}>
          <span className={styles.FormContainerTitle}>희망인터뷰 소요시간</span>
          <div className={styles.Column}>
            <div className={styles.CheckboxContainer}>
              <input type='checkbox' id='less30' name='less30' />
              <label htmlFor='less30' className={styles.Checkbox}>
                30분 미만
              </label>
              <input type='checkbox' id='less60' name='less60' />
              <label htmlFor='less60' className={styles.Checkbox}>
                1시간 미만
              </label>
            </div>
            <div className={styles.CheckboxContainer}>
              <input type='checkbox' id='less180' name='less180' />
              <label htmlFor='less180' className={styles.Checkbox}>
                3시간 미만
              </label>
              <input type='checkbox' id='noproblem' name='noproblem' />
              <label htmlFor='noproblem' className={styles.Checkbox}>
                상관없음
              </label>
            </div>
          </div>
        ...
        <div className={styles.FormContainer3}>
          <span className={styles.FormContainerTitle}>추가시간 보상 단가</span>
          <div className={styles.Column}>
            <div className={styles.CheckboxContainer}>
              <input type='checkbox' id='1000' name='1000' />
              <label htmlFor='1000' className={styles.Checkbox}>
                1000원
              </label>
              <input type='checkbox' id='2000' name='2000' />
              <label htmlFor='2000' className={styles.Checkbox}>
                2000원
              </label>
            </div>
            <div className={styles.CheckboxContainer}>
              <input type='checkbox' id='3000' name='3000' />
              <label htmlFor='3000' className={styles.Checkbox}>
                3000원
              </label>
              <input type='checkbox' id='4000' name='4000' />
              <label htmlFor='4000' className={styles.Checkbox}>
                4000원
              </label>
            </div>
          </div>
