  ...
  return (
    <div>
      ...
      <div className={styles.background2}>
        <div className={styles.description1_page2}>
          <h1>
            IN U IN이 제공하는 최고의 인터뷰 솔루션을 통해
            <br />내 손안의 인터뷰 관리를 경험 해보세요.
          </h1>
        </div>
        <div className={styles.description2_page2}>
          <h3>정성적 인터뷰 참여자 모집</h3>
        </div>
        <div className={styles.description3_page2}>
          <h3>
            정성적 인터뷰에 참여할
            <br />
            인터뷰 희망자를 보다 쉽게
        ...
        <div className={styles.interview_button}>
